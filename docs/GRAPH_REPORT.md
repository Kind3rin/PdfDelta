...
## Summary
- 292 nodes · 856 edges · 22 communities (18 shown, 4 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `830d4138`
...
Cohesion: 0.16
Nodes (24): addFiles(), compareText(), compatibilityMessage(), diffLines(), escapeHtml(), firstCompatibleSuggestion(), getFileProfile(), getOptions() (+16 more)
...
Cohesion: 0.18
Nodes (16): blankPageIndicesFromRenderDoc(), canvasHasVisibleInk(), canvasToBlob(), canvasToGrayscale(), canvasToImageBytes(), canvasToPngBytes(), enhanceScan(), grayscaleRaster() (+8 more)
...
- **Why does `downloadBlob()` connect `downloadBlob` to `app.js`, `isToolCompatible`, `renderPdfPageCanvas`, `Community 6`, `extractTextFromPdfFile`, `openPdfEditorTool`, `removeAttachments`, `pageSizeReport`, `compareVisual`, `blankPdf`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `getPdfFiles()` connect `downloadBlob` to `app.js`, `isToolCompatible`, `renderPdfPageCanvas`, `Community 6`, `extractTextFromPdfFile`, `openPdfEditorTool`, `removeAttachments`, `pageSizeReport`, `compareVisual`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `savePdfBytes()` connect `downloadBlob` to `app.js`, `renderPdfPageCanvas`, `Community 6`, `openPdfEditorTool`, `removeAttachments`, `blankPdf`?**
