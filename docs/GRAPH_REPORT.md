...
## Summary
- 301 nodes · 861 edges · 23 communities (21 shown, 2 thin omitted)
...
Cohesion: 0.14
Nodes (25): addFiles(), compatibilityMessage(), firstCompatibleSuggestion(), getFileProfile(), getOptions(), isToolCompatible(), matchesTool(), profileSummaryText() (+17 more)
